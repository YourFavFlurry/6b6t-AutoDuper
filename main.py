...
def main():
    ...
    menu = ['&Discord', ['cdkw#6346',]],['&Github', ['Visit',]],
    layout = [  
                [sg.Menu(menu)],
    ...
    window = sg.Window('Item Frame Duper', layout, size=(450, 180), font='bold', icon=r"item_frame.ico")
    ...
    while True:
        ...
        if event == 'Subscribe':
            webbrowser.open('https://github.com/cdkw')    
